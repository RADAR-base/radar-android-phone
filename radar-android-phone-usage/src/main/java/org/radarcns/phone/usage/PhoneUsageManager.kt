...
class PhoneUsageManager(context: PhoneUsageService) : AbstractDeviceManager<PhoneUsageService, BaseDeviceState>(context) {
    ...
    private val userInteractionTopic: DataCache<ObservationKey, PhoneUserInteraction> = createCache("android_phone_user_interaction", PhoneUserInteraction::class.java)
    ...
    init {
        ...
        if (usageStatsManager != null) {
            usageEventTopic = createCache("android_phone_usage_event", PhoneUsageEvent::class.java)
        } else {
    ...
    companion object {
        ...
        private const val LAST_EVENT_TYPE = "org.radarcns.phone.usage.PhoneUsageManager.lastEventType"
        private const val LAST_EVENT_IS_SENT = "org.radarcns.phone.usage.PhoneUsageManager.lastEventIsSent"
        ...
        private const val ACTION_UPDATE_EVENTS = "org.radarcns.phone.usage.PhoneUsageManager.ACTION_UPDATE_EVENTS"
