...
class PhoneSensorManager(context: PhoneSensorService) : AbstractDeviceManager<PhoneSensorService, PhoneState>(context), SensorEventListener {
    ...
    private val accelerationTopic: DataCache<ObservationKey, PhoneAcceleration> = createCache("android_phone_acceleration", PhoneAcceleration::class.java)
    private val lightTopic: DataCache<ObservationKey, PhoneLight> = createCache("android_phone_light", PhoneLight::class.java)
    private val stepCountTopic: DataCache<ObservationKey, PhoneStepCount> = createCache("android_phone_step_count", PhoneStepCount::class.java)
    private val gyroscopeTopic: DataCache<ObservationKey, PhoneGyroscope> = createCache("android_phone_gyroscope", PhoneGyroscope::class.java)
    private val magneticFieldTopic: DataCache<ObservationKey, PhoneMagneticField> = createCache("android_phone_magnetic_field", PhoneMagneticField::class.java)
    private val batteryTopic: DataCache<ObservationKey, PhoneBatteryLevel> = createCache("android_phone_battery_level", PhoneBatteryLevel::class.java)
    ...
    companion object {
        ...
        private val ACTIVITY_LAUNCH_WAKE = "org.radarcns.phone.PhoneSensorManager.ACTIVITY_LAUNCH_WAKE"
